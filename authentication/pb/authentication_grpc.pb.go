...
const (
	AuthenticationService_CreateUser_FullMethodName       = "/proto.AuthenticationService/CreateUser"
	AuthenticationService_LoginUser_FullMethodName        = "/proto.AuthenticationService/LoginUser"
	AuthenticationService_RefreshTokenUser_FullMethodName = "/proto.AuthenticationService/RefreshTokenUser"
)
...
type AuthenticationServiceClient interface {
	...
	RefreshTokenUser(ctx context.Context, in *RefreshTokenRequest, opts ...grpc.CallOption) (*TokenResponse, error)
}
...
func (c *authenticationServiceClient) LoginUser(ctx context.Context, in *LoginUserRequest, opts ...grpc.CallOption) (*TokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *authenticationServiceClient) RefreshTokenUser(ctx context.Context, in *RefreshTokenRequest, opts ...grpc.CallOption) (*TokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TokenResponse)
	err := c.cc.Invoke(ctx, AuthenticationService_RefreshTokenUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthenticationServiceServer interface {
	...
	RefreshTokenUser(context.Context, *RefreshTokenRequest) (*TokenResponse, error)
...
func (UnimplementedAuthenticationServiceServer) LoginUser(context.Context, *LoginUserRequest) (*TokenResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LoginUser not implemented")
}
func (UnimplementedAuthenticationServiceServer) RefreshTokenUser(context.Context, *RefreshTokenRequest) (*TokenResponse, error) {
...
func _AuthenticationService_RefreshTokenUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RefreshTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthenticationServiceServer).RefreshTokenUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthenticationService_RefreshTokenUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthenticationServiceServer).RefreshTokenUser(ctx, req.(*RefreshTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthenticationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthenticationService_RefreshTokenUser_Handler,
		},
	},
